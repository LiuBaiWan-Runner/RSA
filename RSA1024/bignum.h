...
void mont_redc(BN DT, BN N, BN Np, BN R, BN & result);//蒙哥马利约简，result=a*b (mod n )
void mont_modmul(BN x, BN y, BN N,BN & result);//蒙哥马利模乘，result=a*b (mod n )
void mont_modmul(BN x, BN y, BN R, BN N, BN Np, BN RRN, BN & result);//用于模幂的模乘
void mont_modexp(BN x, BN y, BN N, BN & result);//蒙哥马利模幂
//信安数学中的函数
...
int miller_b(BN n,int t);//miller-rabin prime test
